        ...
        <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Edit Pekerjaan</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Desain</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)"><?php echo $_GET['desain'] ?></a></li>
                                ...
                                <div class="basic-form">
                                    <form action="../proses/crud_uraian.php" method="post">
                                            ...
                                            <select class="form-control custom-select" name="idjenis">
                                                ...
                                                <?php 
                                                  ...
                                                  while ($row_j = $result_j->fetch_assoc()) {
                                                    if ($row_j['id']==$_GET['idj']) {
                                                        echo "<option value='".$row_j['id']."' selected>".$row_j['jenispekerjaan']."</option>";
                                                    } else{
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="pekerjaan" class="form-control input-default " placeholder="Pekerjaan" value="<?php echo $_GET['pekerjaan'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Volume</label>
                                            <input type="text" name="volume" class="form-control input-default " placeholder="Volume" value="<?php echo $_GET['volume'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Satuan</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="hargasatuan" class="form-control input-default " placeholder="Harga Satuan" value="<?php echo $_GET['hargasatuan'] ?>">
                                        </div>
